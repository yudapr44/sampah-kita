...
<body class="bg-[#f8f9fa] text-[#191c1d] min-h-screen flex flex-col">
    ...
    <!-- FOOTER -->
    <footer class="bg-[#1b4332] py-12 text-center flex flex-col items-center gap-3 mt-auto">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-left mb-8">
                <!-- Brand -->
                <div>
                    <div class="flex items-center gap-2 mb-3">
                        <span class="material-symbols-outlined text-[#c1ecd4] text-[28px]" style="font-variation-settings:'FILL' 1">recycling</span>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-start gap-2 text-sm text-[#a5d0b9]">
                            <span class="material-symbols-outlined text-[16px] mt-0.5">location_on</span>
                            <span>Desa Balonggandu, Kec. Jatisari, Karawang, Jawa Barat</span>
                        </li>
                        @endif
                    </ul>
                </div>
