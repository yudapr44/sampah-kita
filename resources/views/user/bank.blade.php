...
<body class="bg-[#f8f9fa] text-[#191c1d] min-h-screen flex flex-col">
    ...
    <main class="flex-1 w-full pb-16">
        ...
        <!-- Link 3: Panduan Bank Sampah (Di-disable sementara) -->
        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-[#c1c8c2]/30 opacity-70 cursor-not-allowed">
            <div class="flex items-center gap-3">
                <span class="material-symbols-outlined text-[#717973] fill-icon text-[20px]">menu_book</span>
                <span class="text-[13px] font-semibold text-[#717973]">Panduan Bank Sampah – KLHK RI <span class="text-[10px] font-normal italic">(Segera Hadir)</span></span>
            </div>
            <span class="material-symbols-outlined text-[#717973] text-[18px]">lock</span>
        </div>
        </div><!-- /max-w-7xl -->
